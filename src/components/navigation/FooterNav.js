...
const FooterNav = () => (
  <nav className="usa-footer-nav usa-width-two-thirds">
    ...
    <ul className="usa-unstyled-list usa-width-one-fourth usa-footer-primary-content">
      ...
      <li className="usa-footer-secondary-link">
        <Link to="/feedback" activeClassName="usa-current">
          {` `}
          Feedback{` `}
        </Link>
      </li>
    ...
    <ul className="usa-unstyled-list usa-width-one-fourth usa-footer-primary-content">
      ...
      <li className="usa-footer-secondary-link">
        <Link to="/privacy-policy" activeClassName="usa-current">
          {` `}
          Privacy Policy{` `}
        </Link>
      </li>
      <li className="usa-footer-secondary-link">
        <Link to="/licensing-policy" activeClassName="usa-current">
          {` `}
          Licensing Policy
        </Link>
      </li>
      <li className="usa-footer-secondary-link">
        <a
          ...
          className="external-link usa-nav-link"
        >
          {` `}
